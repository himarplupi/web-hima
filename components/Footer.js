            ...
            <div className='max-w-7xl mx-auto'>
                <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10'>
                    <div className='block col-span-2'>
                        ...
                        <p className='mb-10'>Tincidunt mi, amet dignissim ipsum massa integer. Auctor felis, et cursus mattis lorem scelerisque eu justo. Enim nunc quam id facilisis amet. Vitae dolor tempor.</p>
                        <p>© 2022 HIMARPL</p>
                        <span className='text-xs'>Made With ❤ by Departemen Komunikasi dan Informasi </span>
                    </div>
                    <div className='mb-5'>
                ...
                <div className='flex justify-end gap-4'>
                    {socmed.map((item, id) => (
                        <Link key={id} href={item.url}><Image src={item.src} /></Link>
                    ))}
                </div>
            </div>
        </div>
